package dev.darmstadtium271.gtmplusplus.common.data.machines.multiblocks;
...
import dev.darmstadtium271.gtmplusplus.client.renderer.machine.multiblock.steam.LargeSteamOreWasherRenderer;
...
public class SteamMultiblocks {
            ...
            .pattern(multiblockMachineDefinition -> FactoryBlockPattern.start()
                    ...
                    .where("C",
                            Predicates.blocks(CASING_BRONZE_BRICKS.get()).setMinGlobalLimited(49)
                                    ...
                                    .or(Predicates.abilities(PartAbility.STEAM).setExactLimit(1)))
                    .build())
            .renderer(() -> new LargeSteamOreWasherRenderer(
            ...
            .pattern(multiblockMachineDefinition -> FactoryBlockPattern.start()
                    ...
                    .where("C",
                            Predicates.blocks(GTBlocks.CASING_STEEL_SOLID.get()).setMinGlobalLimited(49)
                                    ...
                                    .or(Predicates.abilities(PartAbility.STEAM).setExactLimit(1)))
                    .build())
            .renderer(() -> new LargeSteamOreWasherRenderer(GTCEu.id("block/casings/solid/machine_casing_solid_steel"),
                    GTCEu.id("block/machines/ore_washer")))
    ...
    public static final MachineDefinition LARGE_STEAM_MIXER = REGISTRATE
            ...
            .pattern(multiblockMachineDefinition -> FactoryBlockPattern.start()
                    ...
                    .where("F",
                            Predicates.blocks(Objects
                                    .requireNonNull(
                                            GTMaterialBlocks.MATERIAL_BLOCKS.get(TagPrefix.frameGt, GTMaterials.Bronze))
                                    .get()))
                    .where("I", Predicates.blocks(Blocks.IRON_BLOCK))
                    .where("C",
    ...
    public static void init() {
        GTMultiMachines.STEAM_GRINDER.setTooltipBuilder(((itemStack, components) -> {
            components.add(Component.translatable("gtmplusplus.machine.steam_multiblocks.processing_velocity.tooltip")
                    .withStyle(ChatFormatting.GRAY));
