...
import static dev.darmstadtium271.gtmplusplus.common.data.machines.GTMPPMultiblocks.SteamMultiblocks.*;

public class GTMPPRecipes {

    public static void addRecipes(Consumer<FinishedRecipe> provider) {
        addSteamMultiblockCraftingRecipes(provider);
    }

    public static void addSteamMultiblockCraftingRecipes(Consumer<FinishedRecipe> provider) {
